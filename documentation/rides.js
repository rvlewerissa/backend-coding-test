...
/**
* @api {get} /rides?page=pageNumber&page_len=pageLength Get All Rides Pagination
* @apiName GetRidesPagination
* @apiGroup Rides
*
* @apiParam {Number} pageNumber number of page
* @apiParam {Number} pageLength length of each page
*
* @apiSuccess {Object[]} rides List of rides
* @apiSuccess {Number} rides.rideID Ride ID of the ride
* @apiSuccess {Number} rides.startLat Starting latitude of the ride
